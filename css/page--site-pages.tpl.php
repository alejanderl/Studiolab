...
?>
    ...
    if($tid_theme!=FALSE):
    # Print Feed and iCal links
     $attributes = array('attributes' => array('title' => t('Add to my agenda')), 'html' => TRUE,'target'=>'_blank');
     $attributes_rss = array('attributes' => array('title' => t("Suscribe to RSS")), 'html' => TRUE,'target'=>'_blank');
     ...
     $icalURL2=l('<img src="'.$image_path.'" alt="'.t('Add to my agenda').'">', 'webcal://studiolabproject.eu/ical/'.($tid_theme), $attributes);
     $rssURL2=l('<img src="'.$image_rss_path.'" alt="'.t('Suscribe to RSS').'">', 'http://studiolabproject.eu/term-feeds/'.  ($tid_theme), $attributes_rss);

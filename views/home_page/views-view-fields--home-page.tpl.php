...
$theme=(isset($fields['field_stlab_theme']->content))?$fields['field_stlab_theme']->content:NULL ;
 $city=($fields['field_trm_location']->content)?'<span title="Venue">'.$fields['field_trm_location']->content."</span>":"" ;
...
?>
 ...
 <li>
     ...
     <?php // print flag_create_link('preomoto_to_frontpage', $fields['nid']->raw); ?>
         ...
         <div class="dates water-spot" ><?php print $type; ?> <?php print $organizer; ?> <?php print $city; ?> <?php print $date; ?> </div>
     </div>
</li>

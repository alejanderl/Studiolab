...
<li>
   ...
   <?php print $image; ?>
   <span class="data"><?php print $organizer ?><?php print $asset_type?></span><h3 ><?php print $title; ?></h3>
   <div class="taxos"><span class="data"><span class="data"><?php echo $from_date ?><?php echo $to_date ?> </span></div>
 </li>
